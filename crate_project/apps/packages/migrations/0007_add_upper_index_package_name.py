...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.execute('CREATE UNIQUE INDEX "packages_package_upper_name" ON "packages_package" (UPPER("name"));')

    def backwards(self, orm):
        db.execute('DROP INDEX IF EXISTS "packages_package_upper_name";')

    models = {
        'packages.package': {
            'Meta': {'object_name': 'Package'},
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime(2012, 1, 25, 11, 47, 13, 199137)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime(2012, 1, 25, 11, 47, 13, 199234)'}),
        ...
        'packages.release': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime(2012, 1, 25, 11, 47, 13, 199963)', 'db_index': 'True'}),
            ...
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime(2012, 1, 25, 11, 47, 13, 200060)'}),
        ...
        'packages.releasefile': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime(2012, 1, 25, 11, 47, 13, 198248)', 'db_index': 'True'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime(2012, 1, 25, 11, 47, 13, 198371)'}),
